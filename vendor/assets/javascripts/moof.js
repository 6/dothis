...
var Calendar, make_colorizer, rjust_2_0, strftime_Ymd;
...
make_colorizer = function(c1, c2, v1, v2) {
  return function(v) {
    return interpolateColors(c1, c2, (v1 === v2 ? 0.5 : (v - v1) / (v2 - v1)));
  };
};
...
Calendar = (function() {
  function Calendar(_arg) {
    var MS_IN_DAY, append_to, colorizer, coord, data, datestr, datestr_coord_map, day, dayHolder, day_size, days, days_until_next_sunday, h, k, max_value, num_weeks, t, v, w, x, y, _i, _j, _len, _len2, _ref, _ref2, _ref3, _ref4;
    data = _arg.data, day_size = _arg.day_size, num_weeks = _arg.num_weeks, append_to = _arg.append_to;
    Calendar.__super__.constructor.call(this, 'div', 'Calendar');
    if (append_to) {
      document.getElementById(append_to).appendChild(this._);
    }
    max_value = 0;
    for (_i = 0, _len = data.length; _i < _len; _i++) {
      _ref = data[_i], k = _ref[0], v = _ref[1];
      if (v > max_value) {
        max_value = v;
      }
    }
    ...
    for (x = _ref2 = num_weeks - 1; _ref2 <= 0 ? x <= 0 : x >= 0; _ref2 <= 0 ? x++ : x--) {
      for (y = _ref3 = 7 - 1; _ref3 <= 0 ? y <= 0 : y >= 0; _ref3 <= 0 ? y++ : y--) {
    ...
    for (_j = 0, _len2 = data.length; _j < _len2; _j++) {
      _ref4 = data[_j], datestr = _ref4[0], v = _ref4[1];
      coord = datestr_coord_map[datestr];
      if (coord) {
        days[coord].setStyles({
          background: colorizer(v)
        });
      }
    }
  }
